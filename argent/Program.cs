...
namespace ProjetSymfoCS_Console
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                case "1":
                    AjoutParticipant.AjouterParticipant();
                ...
                case "2":
                    ...
                    int idParticipant= Int32.Parse(numP);
                    AjoutPrix.AjoutPrixIntoBDD(idSoiree, idParticipant);
                ...
                case "3":
                    ...
                    int nbParticipant = AjoutParticipant.GetNbParticipant(IDSoiree);
        ...
        {
            return AjoutParticipant.GetNom(id);
        }
    }
}